...
### Сайт
Создайте две ВМ, установите на них сервер nginx, если его там нет. ОС и содержимое ВМ должно быть идентичным, это будут наши веб-сервера.
...
### Редактирую файл main.tf, описываю допуски и добавляю 2 веб-сервера на Debian (так как это одна из самых безопасных ОС)
![1](/img/1.png)
![2](/img/2.png)
